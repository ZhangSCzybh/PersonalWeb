...
const EyeBall = ({ size = 48, pupilSize = 16, maxDistance = 10, eyeColor = "white", pupilColor = "black", isBlinking = false, forceLookX, forceLookY }) => {
  ...
  return (
    <div
      ref={eyeRef}
      className={`eyeball ${isBlinking ? 'blinking' : ''}`}
      style={{
        width: `${size}px`,
      ...
      <div className="login-left">
        ...
        <div className="characters-container">
          <div className="characters-wrapper">
            <div 
              ref={purpleRef}
              className="character purple-char"
              style={{
            ...
            <div 
              ref={blackRef}
              className="character black-char"
              style={{
                transform: (password.length > 0 && showPassword)
                  ? `skewX(0deg)`
            ...
            <div 
              ref={orangeRef}
              className="character orange-char"
              style={{
            ...
            <div 
              ref={yellowRef}
              className="character yellow-char"
              style={{
      ...
      <div className="login-right">
        <div className="login-card">
          ...
          <div className="form-header">
            ...
            <p>{isRegister ? '填写以下信息创建账号' : '请输入您的账号信息'}</p>
          </div>
